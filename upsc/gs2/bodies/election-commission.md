---
title: Election Commission of India | Constitutional Bodies
---

# Election Commission of India
## Article 324 & Free & Fair Elections
...
- **1950**: Single member (CEC)
- **1989**: Multi-member (CEC + 2 ECs)
- **1993**: Made permanent
- **Equal Powers**: All commissioners
...
:::details **Election Conduct**
- **Delimitation**: Constituency boundaries
- **Electoral Rolls**: Voter registration
- **Schedule**: Election dates
- **Polling Stations**: Allocation
- **Counting**: Supervision
:::

:::details **Model Code of Conduct**
- **Not Statutory**: Convention-based
- **Binding**: Political parties
- **Enforcement**: EC directions
- **Violations**: Action taken
- **Criticism**: Needs legal backing
:::

:::details **Recognition & Symbols**
- **National Parties**: Recognition
- **State Parties**: Registration
- **Symbols**: Allotment
- **Disputes**: Resolution
- **Derecognition**: Can cancel
:::
...
- **VVPAT**: Paper trail 2013
- **Security Concerns**: Hacking fears
- **Opposition Demand**: More verification
- **SC Directions**: 5 booths/assembly
- **Transparency**: Needed more
:::

:::details **Criminalization**
- **43% MPs**: Criminal cases
- **SC Directives**: Disclosure mandatory
- **Affidavits**: Criminal records
- **Disqualification**: Post-conviction only
- **Reform Needed**: Pending cases bar
:::

:::details **Paid News**
- **Media Ethics**: Violation
- **Cash for Coverage**: Unreported
- **Expenditure Ceiling**: Circumvented
- **Detection**: Difficult
- **Penalties**: Inadequate
:::

:::details **Electoral Bonds**
- **2018**: Introduced scheme
- **Anonymity**: Donor identity
- **Transparency**: Compromised
- **SC 2024**: Struck down
- **Quid Pro Quo**: Fears
:::

:::details **Voter Participation**
- **NOTA**: 2013 option
- **Voter Apathy**: Urban areas
- **Incentives**: Needed
- **Awareness**: Campaigns
:::
...
:::details **Digital Reforms**
- **ECI App**: Voter services
- **Online Registration**: Voters
- **E-EPIC**: Digital voter ID
- **Suvidha Portal**: Permissions
- **Webcasting**: Polling stations
:::
...
- **Targeted**: Youth focus
:::

:::details **Accessible Elections**
- **PWD**: Facilities
- **Home Voting**: Senior citizens
- **Postal Ballot**: NRIs limited
- **Gender**: Separate booths
:::
...
- **Elections**: Expensive
- **Money Power**: Reduce
- **Partial Funding**: Consider
- **Transparency**: Increase
:::

:::details **Appointment Process**
- **Collegium**: Similar to judiciary
- **Opposition Consultation**: Include
- **Transparency**: Selection process
- **Independence**: Ensure
:::

:::details **Simultaneous Elections**
- **One Nation One Election**: Proposal
- **Cost Saving**: Claimed
- **Logistical**: Challenges
- **Federal Impact**: Concern
